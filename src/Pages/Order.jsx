                    ...
                    <div className='order-type'>
                        <div className='order-type__buttons'>
                             {orderDetails.map((value,index)=>(
                                <button  className={active===index ? 'button button--active' : "button"} 
                                onClick={()=>onClickChange(index)}>{value}</button>
                             ))}
                           ...
                           <div className='second'>
                            <h3>{totalPrice}  ₼
                             {totalPrice>67 && <span>(-3 )</span>}
                             </h3> 
                            <h3>2   ₼</h3>
                           </div>
                           <div className='third'>
                            <h2>Итого к оплате</h2>
                            <h2>{totalPrice<67 ? totalPrice+2 : endirimPrice+2}  ₼</h2>
                           </div>
                        </div> 
                        : 
                             <div className='order-type__summary'>
