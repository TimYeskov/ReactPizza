              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  >
                    <span
                      className="dropdown-item"
                      onClick={() => dispatch(setCategoryId(3))}
                    >
                  ...
                  >
                    <span
                      className="dropdown-item"
                      onClick={() => dispatch(setCategoryId(4))}
                    >
                  ...
                  >
                    <span
                      className="dropdown-item"
                      onClick={() => dispatch(setCategoryId(5))}
                    >
                  ...
                  >
                    <span
                      className="dropdown-item"
                      onClick={() => dispatch(setCategoryId(6))}
                    >
                  ...
                  >
                    <span
                      className="dropdown-item"
                      onClick={() => dispatch(setCategoryId(7))}
                    >
                      <img src="./img/headerMenuIcon.svg" />
                      Десерты
                    </span>
                  ...
                  >
                    <span
                      className="dropdown-item"
                      onClick={() => dispatch(setCategoryId(8))}
                    >
                      <img src="./img/headerMenuIcon.svg" />
                      Напитки
                    </span>
